...
describe("calculateTransactionFee", () => {
  describe("calculateTransactionFee", () => {
    it("calculates as expected", async () => {
      expect(calculateTransactionFee(0).getSigna()).toEqual("0.01");
      expect(calculateTransactionFee(78215).getSigna()).toEqual("4.45");
    });
  });
  describe("calculateTransactionFeePerMessage", () => {
